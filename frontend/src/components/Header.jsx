    ...
    <header className="h-16 shadow-md  fixed w-full z-50 bg-white ">
      <div className="container max-auto h-full flex px-2 md:px-6 items-center justify-between mx-auto  w-full">
        ...
        <div className="hidden lg:flex rounded-full item-center w-full justify-between max-w-sm focus-within:shadow-sm">
          <input
            className="border w-full outline-none rounded-l-full pl-2 p-2"
            type="text"
        ...
        <div className="flex justify-center items-center gap-10">
          <div
            className="relative  flex justify-center hidden md:block"
            onClick={() => {
              setadmin(!admin);
            }}
          >
              ...
              <div className="absolute bg-white h-fit p-4 bottom-0 top-11 shadow-lg rounde w-fit hidden md:block ">
                <nav>
                  <Link
                    ...
                    className="whitespace-nowrap hover:bg-slate-100 hover:p-1"
                  >
                    Admin panel
                  </Link>
                </nav>
          ...
          {user?._id && (
            <Link to={"cart"} className="text-2xl lg:text-3xl cursor-pointer relative">
              <span>
          ...
          <div className="bg-red-600 md:px-6  p-1 font-medium md:py-2   text-white hover:bg-red-700 transition text-lg rounded">
            {user?._id ? (
